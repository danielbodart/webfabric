...
function runTest() {
	...
	synchronize(function() {
		$('<p id="testresult" class="result"/>').html(['Tests completed in ',
			...
			'<span class="good">', config.stats.all - config.stats.bad, '</span> tests of <span class="all">', config.stats.all, '</span> passed, <span class="bad">', config.stats.bad,'</span> failed.']
			.join(''))
			.appendTo("body");
